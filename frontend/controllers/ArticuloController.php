...
class ArticuloController extends Controller
{
    ...
    public function actionView($id_articulo, $id_escuela, $id_estados, $id_categoria)
    {
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Articulo #".$id_articulo, $id_escuela, $id_estados, $id_categoria,
                    'content'=>$this->renderAjax('view', [
                        'model' => $this->findModel($id_articulo, $id_escuela, $id_estados, $id_categoria),
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Edit',['update','id_articulo, $id_escuela, $id_estados, $id_categoria'=>$id_articulo, $id_escuela, $id_estados, $id_categoria],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];
        }else{
    ...
    public function actionUpdate($id_articulo, $id_escuela, $id_estados, $id_categoria)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update Articulo #".$id_articulo, $id_escuela, $id_estados, $id_categoria,
